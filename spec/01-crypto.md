# 01 — Cryptography: BDHKE, hash-to-curve, DLEQ

**Version: 0.1** · Status: implemented (`packages/crypto`) · Test vectors: [`vectors/crypto-v0.1.json`](vectors/crypto-v0.1.json)
...
1. Client picks a **secret** `x` (arbitrary bytes; see [04](04-mpp-method.md) for structured secrets) and computes `Y = hash_to_curve(x)`.
